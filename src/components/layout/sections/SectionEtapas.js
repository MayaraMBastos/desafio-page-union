...
function SectionEtapas() {
  return (
    <section className={`${stylesContainer.section}`}>
      ...
      <p className="sc-kAkpmW lmUHeL">
        Conheça as etapas do nosso processo seletivo
      </p>
      <div className="sc-gFVvzn cQzpBG">
        <div className="sc-bXCLTC jAskVB">
          <ol className="sc-eeDRCY hvIbGv">
            <li>
              <div className="opacity-0 translate-y-2.5 transform">
                <span>1</span>
                <div className="opacity-0 translate-y-2.5 transform">
